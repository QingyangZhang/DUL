...
def calc_metrics_new(loader, model, criterion, t):
    ...
    #print(get_metric_values(loader, model, criterion, t))
    #exit(0)
    acc, softmax, correct, logit, label = get_metric_values(loader, model, criterion, t)
    # aurc, eaurc
    aurc, eaurc = calc_aurc_eaurc(softmax, correct)
    # fpr, aupr
    aupr, fpr = calc_fpr_aupr(softmax, correct)
...
def get_metric_values(loader, model, criterion, t):
    ...
    with torch.no_grad():
        ...
        for input, target in loader:
            ...
            list_label.extend(target.cpu().data.numpy())
    ...
    return total_acc.item(), list_softmax, list_correct, list_logit, list_label
